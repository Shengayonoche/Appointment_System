...
public class main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(340, 580, 150, 40);
...
// Student email and password format check
...
if (role.equals("staff")) {
    ...
    // Optional: Add specific password rules for staff here if needed
}

try {
    // Proceed to the correct JFrame based on the role
    if (role.equals("student")) {
     new student(email).setVisible(true); // Email saved statically in studentdb
